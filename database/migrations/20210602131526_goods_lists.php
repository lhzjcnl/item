...
class GoodsLists extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table  =  $this->table('goods_lists',array('engine'=>'MyISAM'));
        $table->addColumn('goods_types_id', 'integer',array('limit'  =>  10,'default'=>0,'comment'=>'商品分类id'))
