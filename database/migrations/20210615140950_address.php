...
class Address extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('users_id', 'integer',array('limit'  =>  10,'default'=>0,'comment'=>'用户id'))
            ->addColumn('name', 'string',array('limit'  =>  10,'default'=>'','comment'=>'用户名'))
            ->addColumn('address', 'string',array('limit'  =>  100,'default'=>'','comment'=>'地址'))
